...
class SellForm(forms.Form):
    ...
    book_condition = forms.ChoiceField(label='Book Condition', choices=[("likenew", "Like new"), ("verygood", "Very good"), ("good", "Good"), ("acceptable", "Acceptable")], widget=forms.RadioSelect(attrs={'class': 'form-check-input'}))
